...
def get_dataset(name):
    if name == 'MNIST':
        return datasets.MNIST('/data/yefan0726/data/cv', train=True, download=True,
                       transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
                       ])), \
                datasets.MNIST('/data/yefan0726/data/cv', train=False, transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
                       ])), 10
    elif name == 'CIFAR10':
        ...
        trainset = datasets.CIFAR10(root='/data/yefan0726/data/cv/cifar10', train=True, download=True, transform=transform_train)
        testset = datasets.CIFAR10(root='/data/yefan0726/data/cv/cifar10', train=False, download=True, transform=transform_test)
        ...
        cifar100_train = datasets.CIFAR100(root='/data/yefan0726/data/cv/cifar100', train=True, download=True, transform=transform_train)
        transform_test = transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize(mean, std)
        ])
        cifar100_test = datasets.CIFAR100(root='/data/yefan0726/data/cv/cifar100', train=False, download=True, transform=transform_test)
